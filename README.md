...
You can install the latest version of prioritizedeforestationhotspots
...
aforementioned paper (note that estimating the model accuracy takes
hours!):
...
If you don’t have time to run the model, you can just load the results
already stored in the package. This example shows the deforestation
hotspots in a map:
...
We also included the variables used for the model. This example shows
some of the data included in this package:
